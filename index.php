...
<body>
	...
	<div class="fixed-top border" style="width: 100%; background: white; height: 10.7%;">
		<nav class="navbar navbar-expand-lg navbar-light" style="padding-top: 0.85%; margin-left: 83px;">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-family: Segoe UI; float: left;">
				...
				<button class="font-weight-bold" style="background-color: #ecf0f1; font-size: 0.6vw; border-radius: 20px; padding: 10px; border: transparent; margin-right: 20px;">MODE MALAM</button>
				<button style="background: transparent; margin-right: 10px; border: transparent;"><i class="fas fa-share-alt"></i></button>
				<button style="border: transparent; border-radius: 20px; padding: 5px; padding-right: 10px; padding-left: 10px; margin-right: 83px;"><i class="fas fa-search"></i></button>
			</div><br>
		</nav>
	</div>
	<!-- End Header -->
	...
	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" style="width: 800px;">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="image/news1.jpg" alt="First slide" style="height: 400px;">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="image/news2.jpg" alt="Second slide" style="height: 400px;">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="image/news3.jpg" alt="Third slide" style="height: 400px;">
			</div>
		</div>
	...
	<!-- Content -->
	<div class="container-fluid" style="width: 90%; height: 800px; margin-top: 40px;">
		<span class="font-weight-bold" style="font-size: 1.5vw; text-align: left;">DAFUNDA LATEST</span>
		<div class="row">
			<div class="col-10">
				<span class="font-weight-bold border" style="font-size: 1.5vw; float: left; margin-top: 1%; border-radius: 5px;">
					<img src="image/news1.jpg" style="width: 30%; height: auto; border-radius: 10px; float: left;">
					<span style="margin-left: 2%;">Bad Genius 2 Dikabarkan Akan Dirilis Tahun 2020!!<br>
			...
			<div class="col-10">
				<span class="font-weight-bold border" style="font-size: 1.5vw; float: left; margin-top: 3%; border-radius: 5px;">
					<img src="image/news2.jpg" style="width: 30%; height: auto; border-radius: 10px; float: left;">
					<span style="margin-left: 2%;">Film Alita mendapatkan Reward Hollywood!!<br>
						<img src="image/miccajr.jpg" style="border-radius: 50%; width: 5%; height: auto; top: 0; float: left; margin-left: 2%;">
						<span class="font-weight-normal" style="font-size: 0.8vw; color: #c4c4c2; float: left; padding-left: 1%;">oleh 
							<span style="color: black;">Micca JR
							</span><br>sekitar 6 jam yang lalu
						</span>
					</span>
				</span>
			</div>
			<div class="col-10">
				<span class="font-weight-bold border" style="font-size: 1.5vw; float: left; margin-top: 3%; border-radius: 5px;">
					<img src="image/news3.jpg" style="width: 30%; height: auto; border-radius: 10px; float: left;">
					<span style="margin-left: 2%;">Violet Evergarden Resmi Mendapatkan Movie Ke-2nya!!<br>
						<img src="image/miccajr.jpg" style="border-radius: 50%; width: 5%; height: auto; top: 0; float: left; margin-left: 2%;">
						<span class="font-weight-normal" style="font-size: 0.8vw; color: #c4c4c2; float: left; padding-left: 1%;">oleh 
							<span style="color: black;">Micca JR
							</span><br>sekitar 11 jam yang lalu
						</span>
					</span>
				</span>
			</div>
